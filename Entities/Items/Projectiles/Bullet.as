...
void onCollision(CBlob@ this, CBlob@ blob, bool solid, Vec2f normal, Vec2f point1)
{
	if (blob !is null && doesCollideWithBlob(this, blob) && !this.hasTag("collided"))
	{
		...
		dmg = BulletHitBlob(this, point1, initVelocity, dmg, blob, Hitters::shield);
		...
		if (dmg > 0.0f)
		{
			...
			this.server_Hit(blob, point1, initVelocity, dmg, Hitters::shield);
		}
	}
}
...
void Pierce(CBlob @this, CBlob@ blob = null)
{
	...
	{
		BulletHitMap(this, end, this.getOldVelocity(), 0.5f, Hitters::shield, blob);
	}
...
void BulletHitMap(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, u8 customData, CBlob@ hitBlob = null)
{
	...
	if (map.getBlobsInRadius(worldPoint, this.getRadius() * 1.3f, @blobsInRadius))
	{
		for (uint i = 0; i < blobsInRadius.length; i++)
		{
			...
			{
				this.server_Hit(b, worldPoint, Vec2f(0, 0), velocity.Length() / 7.0f, Hitters::shield);
				break;
			}
		}
	}
...
{
	if (this !is hitBlob && customData == Hitters::shield)
	{
