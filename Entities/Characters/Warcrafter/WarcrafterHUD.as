...
void onRender(CSprite@ this)
{
	...
	// draw class icon
	if (blob.get_bool("weapon_mode"))
		GUI::DrawIcon("WarcrafterIcons.png", 2, Vec2f(16, 32), tl + Vec2f(8 + (slotsSize - 1) * 40, -13), 1.0f);
	else GUI::DrawIcon(iconsFilename, 3, Vec2f(16, 32), tl + Vec2f(8 + (slotsSize - 1) * 40, -13), 1.0f);
