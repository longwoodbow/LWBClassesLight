...
const string iconsFilename = "Entities/Characters/Duelist/DuelistIcons.png";
...
void ManageCursors(CBlob@ this)
{
	...
	else
	{
		...
		{
			getHUD().SetCursorImage("Entities/Characters/Duelist/DuelistCursor.png", Vec2f(32, 32));
